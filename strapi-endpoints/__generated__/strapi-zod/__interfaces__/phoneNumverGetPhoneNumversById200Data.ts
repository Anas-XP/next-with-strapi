 ...
 */
import type { PhoneNumverGetPhoneNumversById200DataId } from "./phoneNumverGetPhoneNumversById200DataId";
import type { PluginUsersPermissionsUserDocument } from "./pluginUsersPermissionsUserDocument";

export type PhoneNumverGetPhoneNumversById200Data = {
  /**
   * The document ID, represented by a UUID
   * @pattern ^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000)$
   */
  documentId: string;
  id: PhoneNumverGetPhoneNumversById200DataId;
  /**
   * An integer field
